...
\IfFileExists{replication/results/context-figures/contratos-ia.tex}{%
  \input{replication/results/context-figures/contratos-ia.tex}%
}{%
  \begin{quote}\small
  \textbf{Evidencia contextual no disponible.} La figura generada no forma parte del
  paquete actual. Esta ausencia se conserva explícitamente y no se reemplaza con cifras
  inferidas. El análisis conceptual continúa sin atribuir resultados a ese artefacto.
  \end{quote}%
}
