...
| VSN-001 | Catálogo versionado | candidata versionada | catálogo inválido | banco de fallos 30/30 | lectura multiversión real | Core 1.1 | parcial |
...
| PUB-001 | Publicación por versión | activa separada de candidata | interrupciones 25/50/75 | banco de fallos 90/90 | intercambio atómico no implementado | Core 1.1 | parcial |
...
| SEC-001 | Recuperación limitada | ámbitos separados | S1 | conformidad | autorización del motor | modelo de amenazas | cubierta funcional |
