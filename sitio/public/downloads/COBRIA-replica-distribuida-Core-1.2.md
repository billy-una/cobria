...
Se ejecutaron 270 corridas confirmatorias: tres motores, tres escalas y treinta repeticiones por celda. Todas superaron conjuntamente P1, P2, R1, S1 y A1. En ninguna corrida se recuperaron documentos de un ámbito ajeno.
...
La evidencia respalda conformidad funcional de los tres adaptadores evaluados dentro del arnés. No prueba disponibilidad regional, particiones de red, consenso, seguridad exhaustiva ni desempeño administrado. La siguiente réplica técnica debe ejecutar OpenSearch 3.2.0 en ARM nativo o infraestructura externa y debe añadir cargas concurrentes multiusuario.
